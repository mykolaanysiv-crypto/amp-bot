# AMP XP / «АМПасадори» v1.17.2.3 — Quick XP Builder & Admin UX

v1.17.2.3 розширює **«⚡ Швидкі XP»** до конструктора з динамічними полями та багатопитальними мініквізами з XP за кожну правильну відповідь. Тижневий cap за замовчуванням — 30 XP і керується у Web → «Налаштування». Також оновлено редактор опитувань і вирівняно картки квестів. Alembic head — `20260921_0012`.
