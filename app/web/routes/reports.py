...
from app.web.dependencies import (
    HTMLResponse, HTTPException, Request, Response, build_period_report, ctx, db, guard, is_superadmin, log_audit, report_excel, report_pdf, resolve_report_period, templates
)
