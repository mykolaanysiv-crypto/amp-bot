...
from app.web.dependencies import (
    File, Form, HTMLResponse, HTTPException, RedirectResponse, Request, UploadFile, User, UserStatus, VolunteerTask, VolunteerTaskParticipation, approve_volunteer_task_participation, compose_optional_datetime_fields, ctx, db, delete, delete_image, func, guard, guard_permission, log_audit, normalize_task_xp, notify_telegram, or_, save_image, select, templates, timedelta
)
