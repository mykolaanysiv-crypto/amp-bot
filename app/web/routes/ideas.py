...
from app.web.dependencies import (
    File, Form, HTMLResponse, HTTPException, Idea, RedirectResponse, Request, UploadFile, User, UserStatus, award_idea_approval_once, ctx, datetime, db, delete_image, guard, html_escape, idea_status_label, log_audit, notify_telegram, opt_int, or_, save_image, select, sql_case, templates, timedelta
)
