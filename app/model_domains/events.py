...
class Event(Base):
    ...
    no_show_penalty_xp: Mapped[int] = mapped_column(Integer, default=5)
...
class EventRegistration(Base):
    ...
    registration_source: Mapped[str] = mapped_column(String(24), default="participant")
    ...
    attendance_xp_awarded: Mapped[int] = mapped_column(Integer, default=0)
    preregistration_bonus_xp_awarded: Mapped[int] = mapped_column(Integer, default=0)
    no_show_penalty_xp_applied: Mapped[int] = mapped_column(Integer, default=0)
    volunteer_hours_awarded: Mapped[float] = mapped_column(Float, default=0)
