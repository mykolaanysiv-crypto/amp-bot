...
RULE_SPECS: tuple[RuleSpec, ...] = (
    ...
    RuleSpec("quick_xp.weekly_cap", "quick_xp", "Тижневий ліміт швидких XP", 30, 1, 500, "XP", "Максимум XP, які один учасник може отримати зі швидких завдань за календарний тиждень."),
    ...
    RuleSpec("events.checkin_close_after_end_minutes", "events", "Закрити відмітку після завершення", 60, 0, 1440, "хв", "Через скільки хвилин після часу завершення події закрити QR-відмітку та звичайне підтвердження участі."),
    RuleSpec("events.feedback_after_end_minutes", "events", "Зворотний зв’язок після завершення", 10, 0, 10080, "хв", "Через скільки хвилин після часу завершення події надіслати короткий відгук учасникам."),
    RuleSpec("events.feedback_reminder_hours", "events", "Одноразове нагадування про відгук", 24, 1, 168, "год", "Через скільки годин один раз нагадати про незавершений мікровідгук."),
...
SECTIONS = {
    ...
    "quick_xp": ("⚡ Швидкі XP", "Ліміти коротких завдань, які учасники можуть виконувати прямо в Telegram."),
