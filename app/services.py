...
from .domain_services import (
    ...
    confirm_single_event_attendance, admin_scan_event_participant, force_event_registration_status,
    reconcile_event_registration_rewards, event_preregistration_bonus_eligible, confirm_event_attendance, log_audit, seed_default_team,
